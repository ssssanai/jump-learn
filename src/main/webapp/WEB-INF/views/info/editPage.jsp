...
<div class="wrap">
    <form id="frmWrite" name="frmWrite" action="/info/editPage/${dto.id}" method="post">
        ...
        <div class="formBtn">
            ...
            <input class="endBtn" onclick="location.href = '/info/searchListPage';" type="button" value="목록">
