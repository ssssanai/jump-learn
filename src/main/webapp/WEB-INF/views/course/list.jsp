...
<div class="wrap">
    ...
    <div class="main">
            <form name="frm_search" id="frm_search" class="frm_search" method="get" action="/course/list">
                ...
                <input type="text" name="search_word" id="search_word" class="search_word" placeholder="강좌명을 검색하세요." <c:if test="${searchDTO.search_word != null and searchDTO.search_word != ''}">value="${searchDTO.search_word}"</c:if> />
                        ...
                        <c:when test="${not empty courseList }">
                            <c:forEach items="${courseList}" var="course">
                                <div class="course">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#06C755" class="bi bi-bag-check" viewBox="0 0 24 8">
