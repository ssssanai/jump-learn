...
<div class="wrap">
    ...
    <div class="main">
        ...
        <div class="formBox">
            <form method="post" action="/news/editPage" enctype="multipart/form-data">
                ...
                <div class="formBtn">
                    ...
                    <c:if test="${adminInfo != null}">
                        ...
                        <input class="endBtn" type="button" value="삭제"
                               onClick="if (confirm('${dto.title} 글을 삭제하시겠습니까?')) {location.href='/news/delete/${dto.id}?${pageDTO.linkParams}';}"/>
                    </c:if>
                </div>
            </form>
        </div>
