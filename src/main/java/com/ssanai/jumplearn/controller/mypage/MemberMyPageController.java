...
public class MemberMyPageController {
	...
	public String myStudyRoom(
		...
		// 강좌 페이징
		String EnrollPaging = BbsPage.pagingArea(totalCount, reqDTO.getPage_no(), reqDTO.getPage_size(), reqDTO.getPage_block_size(), req.getContextPath() + "studyroom?" + reqDTO.getLinkParams() + "&sort_order" + reqDTO.getSort_order());
